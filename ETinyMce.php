   ...
   *
   ...
   protected function makeFullEditor($url='')
   {
      ...
      $options['theme_advanced_path_location'] = 'bottom';
		$options['theme_advanced_buttons1'] = "undo,redo,|,removeformat,cleanup,|,visualaid,visualchars,|,ltr,rtl,|,code,preview,|,hr,advhr,nonbreaking,|,charmap,image,|,link,unlink";
		$options['theme_advanced_buttons2'] = "{$sc}formatselect,fontselect,fontsizeselect,|,forecolor,backcolor,|,styleprops,del,ins,attribs";
        $options['theme_advanced_buttons3'] = "bold,italic,underline,strikethrough,|,sub,sup,|,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent";
		$options['theme_advanced_buttons4'] = "";
		$options['theme_advanced_buttons5'] = "{$c2}tablecontrols,|,insertlayer,moveforward,movebackward,absolute";
		$options['theme_advanced_toolbar_location'] = "'top'";
		$options['theme_advanced_toolbar_align'] = "'left'";
